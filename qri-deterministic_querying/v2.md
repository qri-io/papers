...
```sql
SELECT datestamp, lat, lng, precip\_amt FROM precip WHERE precip_amt > 1000
```
...
So the question stands, why go to all this effort calculating abstract queries and structures? The advantage of using these abstract forms becomes clear when isolated & placed on a content-addressed network. At time of addition, we separate out the abstract structure as an independant file & write it to the network, which gives us a concrete hash. For example, here is the above output dataset in it's referenced form:
...
<p align="center">
  <img src="graphics/shared_abstract_structure.png">
</p>
...
<p align="center">
  <img src="graphics/shared_abstract_structure_in_query.png">
</p>
